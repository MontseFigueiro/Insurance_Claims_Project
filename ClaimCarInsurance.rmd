...
```{r}
train_Missing_Values <- train[,8:21]
train_Missing_Values <- train_Missing_Values[!is.na(train_Missing_Values$Blind_Submodel),]
unique(is.na(train_Missing_Values$Blind_Submodel))
train_Missing_Values_muestra <- train_Missing_Values[1:10000,]
train_Missing_Values_muestra_P <- md.pattern(train_Missing_Values)
```
...
gregadosubmodelo <- aggregate(Cat1+Cat2+Cat3+Cat4+Cat5+Cat6+Cat7+Cat8+Cat9~Blind_Submodel,train,length)
